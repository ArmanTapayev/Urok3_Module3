			...
			case 7:
			{
				...
				cin >> C;
					...
					if ((A + B + C) % 3 == 0)
					{
						...
						cout << endl;
						//cout << "Необходимо пересадить " << (A + B + C) / average << " пассажиров." << endl;
						...
						if ((C - average)>0) cout << "Из третьей маршрутки нужно высадить " << abs(C - average) << " пассажиров." << endl;
							...
							/*if (D > F && D > E) cout << "Наименьшее количество для пересадки: " << D << " пассажиров" << endl;
								else if(F > D && F > E) cout << "Наименьшее количество для пересадки: " << F << " пассажиров" << endl;
									else if(E > D && E > F) cout << "Наименьшее количество для пересадки: " << E << " пассажиров" << endl;*/
					}
					else
